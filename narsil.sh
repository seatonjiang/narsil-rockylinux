...
function narsil_logo()
{
    ...
    msg_info '%s\n'   'This is the version for Rocky Linux!                                  '
    msg_info '%s\n\n' 'For more information: https://github.com/seatonjiang/narsil-rockylinux'
...
function narsil_help()
{
    ...
    printf '%s\n\n' "   Submit bug reports or suggestions to $(tput setaf 2)$(tput bold)https://github.com/seatonjiang/narsil-rockylinux/issues$(tput sgr0)"
}
